...
int main(int argc, char *argv[]){
    ...
    // uint8_t in[] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x21};
    //                         0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff}; 
    ...
    // cout << "Size of  " << sizeof(in) << endl;

    uint8_t *out = cipher.Encrypt_CTR(in, key, ctr, sizeof(in));
    uint8_t *neww = cipher.Decrypt_CTR(out, key, ctr, 16);
